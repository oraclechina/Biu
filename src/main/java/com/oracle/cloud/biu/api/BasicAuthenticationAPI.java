...
public class BasicAuthenticationAPI {
	...
	public static String ENDPOINT = "https://api-z12.compute.em2.oraclecloud.com";
	...
	public static String CLOUD_USERNAME = "/Compute-gse00000578/cloud.admin";
	public static String CLOUD_DOMAIN = "gse00000578";
	public static String CLOUD_UNDOMAIN = "Compute-" + CLOUD_DOMAIN;	
	public static String CLOUD_PASSWORD = "entEraL@1SHIN";
	public static String CLOUD_TENANT = "zhiqi1_";
