...
public class EncryptUtil {
    ...
    protected static String key = "LmMGStGtOpF4xNyvYt54EQ==";  
     ...
     * @return 加密后的字符串 
     */  
    protected static String encrypt(String xmlStr) {  
        byte[] encrypt = null;  
     ...
     * @throws Exception 
     */  
    protected static String decrypt(String xmlStr) throws Exception {  
        // base64解码  
     ...
     * @throws Exception 
     */  
    protected static byte[] TripleDES_CBC_Encrypt(byte[] sourceBuf,  
     ...
     * @throws Exception 
     */  
    protected static byte[] TripleDES_CBC_Decrypt(byte[] sourceBuf,  
            SecretKeySpec deskey, IvParameterSpec ivParam) throws Exception {  
     ...
     * @throws Exception 
     */  
    protected static byte[] DES_CBC_Encrypt(byte[] sourceBuf,  
            SecretKeySpec deskey, IvParameterSpec ivParam) throws Exception {  
        byte[] cipherByte;  
        // 使用DES对称加密算法的CBC模式加密  
     ...
     * @throws Exception 
     */  
    protected static byte[] DES_CBC_Decrypt(byte[] sourceBuf,  
            SecretKeySpec deskey, IvParameterSpec ivParam) throws Exception {  
     ...
     * @return 字节数组的二进制表示。 
     */  
    protected static String byte2hex(byte[] inStr) {  
        String stmp;  
    ...
    public static void main(String[] args) {  
        System.out.println(encrypt("sdkjfkdsljflkdsfjdslfksdjlfks"));  
        try {
        	String source = decrypt("qJIE78z8sYaM04qb2J/buTU6SvEKWNermJgdsYehr5stY62ERi5ZAaCeSRs6ZrtW");
